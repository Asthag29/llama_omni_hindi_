...
**[Pastaaaaa2003/hindi-llama-omni](https://huggingface.co/datasets/Pastaaaaa2003/hindi-llama-omni)**
...
- **LLaMA 3B** — `models/llama/`
- **Whisper** — downloaded automatically via `openai-whisper`
